...
const STAY_INSPIRED_CARDS = [
  { image: '/media/footer/card-1.jpg', title: 'From Innovation to Impact', subtitle: '지속가능한 내일로 가는 길' },
  { image: '/media/footer/card-2.jpg', title: 'From Innovation to Impact', subtitle: '지속가능한 내일로 가는 길' },
  { image: '/media/footer/card-3.jpg', title: 'From Innovation to Impact', subtitle: '지속가능한 내일로 가는 길' },
]

const MENU_COLUMNS = [
  { title: 'Investor Relations', items: ['IR Highlights', 'Corporate', 'Financial', 'Official Notice', 'Library'] },
  { title: 'Sustainability', items: ['ESG', 'Environmental', 'Social', 'Governance'] },
  { title: 'Join the Movement', items: ['Career'] },
]
...
export default function Footer() {
  return (
    <footer className="bg-black px-2 pb-2 pt-3 lg:px-5 lg:pb-5 lg:pt-4 relative -top-40">
      ...
      >
        <h2 className="text-[28px] leading-[42px] text-white lg:text-[36px] lg:leading-[54px]">Stay Inspired</h2>
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3 lg:mt-12 lg:gap-6">
          {STAY_INSPIRED_CARDS.map((card, i) => (

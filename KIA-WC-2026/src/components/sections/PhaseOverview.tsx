...
const PHASES = [
  {
    ...
    pc: '/media/phases/pc-phase1.jpg',
    mw: '/media/phases/mw-phase1.jpg',
  },
  {
    id: 'phase-2',
    label: 'Phase 2',
    ...
    pc: '/media/phases/pc-phase2.jpg',
    mw: '/media/phases/mw-phase2.jpg',
  },
  {
    id: 'phase-3',
    label: 'Phase 3',
    ...
    pc: '/media/phases/pc-phase3.jpg',
    mw: '/media/phases/mw-phase3.jpg',
  },
  {
    id: 'phase-4',
    label: 'Phase 4',
    ...
    pc: '/media/phases/pc-phase4.jpg',
    mw: '/media/phases/mw-phase4.jpg',
  },
]
      ...
      <div className="rounded-2xl bg-[#e8eaeb] px-6 pb-10 pt-12 lg:px-20 lg:pb-16 lg:pt-[60px]">
        ...
        >
          <h2 className="text-[24px] leading-9 text-[#05141f] lg:text-[36px] lg:leading-[54px]">
            Official Match Ball Carrier, The World Cup™'s 49th Team
          </h2>
          <div className="flex flex-col items-start gap-2 text-[14px] leading-6 text-[#303e48] lg:w-[464px] lg:gap-4 lg:text-[16px] lg:leading-7">
            <p>
              The FIFA World Cup 2026™ — the largest in history, bringing together 48 nations. On
              that stage, one final team takes its place.
            </p>
            <p>
              Rising football talents selected through local auditions around the world come
              together at the Kia OMBC Cup 2026™. More than just a tournament, it is a space where
              inspiration flows between players — children learning from legends, sharing the same
              dream with new friends, connected through the universal language of the game. United
              as one, they come together as the 49th Team stepping onto the FIFA World Cup™ stage.
              Discover their stories — united by passion for football and shared dreams.
            </p>
          </div>
        </motion.div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 lg:mt-14 lg:grid-cols-4 lg:gap-6">
          {PHASES.map((phase, i) => (
            ...
            >
              <PhaseCard phase={phase} pc={isDesktop ? phase.pc : phase.mw} />
            </motion.div>
          ))}
        </div>
      </div>

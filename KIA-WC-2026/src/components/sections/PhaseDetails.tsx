...
function PhaseDetailCard({ phase }: { phase: (typeof PHASES)[number] }) {
  ...
  return (
    <section
      id={phase.id}
      className="isolate relative mx-2 my-3 scroll-mt-24 overflow-hidden rounded-2xl border border-white/10 px-6 py-10 lg:mx-5 lg:my-4 lg:scroll-mt-28 lg:px-20 lg:py-[60px]"
    >
